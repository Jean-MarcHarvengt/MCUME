...
void REGPARAM2 CPU_OP_NAME(_50fa)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s16 dummy = nextiword();
	if (cctrue(0)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_50fb)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s32 dummy = nextilong();
	if (cctrue(0)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_50fc)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
	if (cctrue(0)) Exception(7,oldpc-2);
}}
...
void REGPARAM2 CPU_OP_NAME(_51fa)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s16 dummy = nextiword();
	if (cctrue(1)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_51fb)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s32 dummy = nextilong();
	if (cctrue(1)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_51fc)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
	if (cctrue(1)) Exception(7,oldpc-2);
}}
...
void REGPARAM2 CPU_OP_NAME(_52fa)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s16 dummy = nextiword();
	if (cctrue(2)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_52fb)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s32 dummy = nextilong();
	if (cctrue(2)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_52fc)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
	if (cctrue(2)) Exception(7,oldpc-2);
}}
...
void REGPARAM2 CPU_OP_NAME(_53fa)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s16 dummy = nextiword();
	if (cctrue(3)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_53fb)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s32 dummy = nextilong();
	if (cctrue(3)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_53fc)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
	if (cctrue(3)) Exception(7,oldpc-2);
}}
...
void REGPARAM2 CPU_OP_NAME(_54fa)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s16 dummy = nextiword();
	if (cctrue(4)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_54fb)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s32 dummy = nextilong();
	if (cctrue(4)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_54fc)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
	if (cctrue(4)) Exception(7,oldpc-2);
}}
...
void REGPARAM2 CPU_OP_NAME(_55fa)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s16 dummy = nextiword();
	if (cctrue(5)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_55fb)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s32 dummy = nextilong();
	if (cctrue(5)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_55fc)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
	if (cctrue(5)) Exception(7,oldpc-2);
}}
...
void REGPARAM2 CPU_OP_NAME(_56fa)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s16 dummy = nextiword();
	if (cctrue(6)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_56fb)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s32 dummy = nextilong();
	if (cctrue(6)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_56fc)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
	if (cctrue(6)) Exception(7,oldpc-2);
}}
...
void REGPARAM2 CPU_OP_NAME(_57fa)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s16 dummy = nextiword();
	if (cctrue(7)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_57fb)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s32 dummy = nextilong();
	if (cctrue(7)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_57fc)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
	if (cctrue(7)) Exception(7,oldpc-2);
}}
...
void REGPARAM2 CPU_OP_NAME(_58fa)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s16 dummy = nextiword();
	if (cctrue(8)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_58fb)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s32 dummy = nextilong();
	if (cctrue(8)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_58fc)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
	if (cctrue(8)) Exception(7,oldpc-2);
}}
...
void REGPARAM2 CPU_OP_NAME(_59fa)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s16 dummy = nextiword();
	if (cctrue(9)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_59fb)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s32 dummy = nextilong();
	if (cctrue(9)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_59fc)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
	if (cctrue(9)) Exception(7,oldpc-2);
}}
...
void REGPARAM2 CPU_OP_NAME(_5afa)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s16 dummy = nextiword();
	if (cctrue(10)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_5afb)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s32 dummy = nextilong();
	if (cctrue(10)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_5afc)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
	if (cctrue(10)) Exception(7,oldpc-2);
}}
...
void REGPARAM2 CPU_OP_NAME(_5bfa)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s16 dummy = nextiword();
	if (cctrue(11)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_5bfb)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s32 dummy = nextilong();
	if (cctrue(11)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_5bfc)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
	if (cctrue(11)) Exception(7,oldpc-2);
}}
...
void REGPARAM2 CPU_OP_NAME(_5cfa)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s16 dummy = nextiword();
	if (cctrue(12)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_5cfb)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s32 dummy = nextilong();
	if (cctrue(12)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_5cfc)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
	if (cctrue(12)) Exception(7,oldpc-2);
}}
...
void REGPARAM2 CPU_OP_NAME(_5dfa)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s16 dummy = nextiword();
	if (cctrue(13)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_5dfb)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s32 dummy = nextilong();
	if (cctrue(13)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_5dfc)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
	if (cctrue(13)) Exception(7,oldpc-2);
}}
...
void REGPARAM2 CPU_OP_NAME(_5efa)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s16 dummy = nextiword();
	if (cctrue(14)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_5efb)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s32 dummy = nextilong();
	if (cctrue(14)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_5efc)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
	if (cctrue(14)) Exception(7,oldpc-2);
}}
...
void REGPARAM2 CPU_OP_NAME(_5ffa)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s16 dummy = nextiword();
	if (cctrue(15)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_5ffb)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
{	uae_s32 dummy = nextilong();
	if (cctrue(15)) Exception(7,oldpc-2);
}}}
void REGPARAM2 CPU_OP_NAME(_5ffc)(uae_u32 opcode) /* TRAPcc */
{
{	uaecptr oldpc = m68k_getpc();
	if (cctrue(15)) Exception(7,oldpc-2);
}}
