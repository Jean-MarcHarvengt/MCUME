...
void mem_updatemap()
{
	...
	byte **map;
	map = mbc.rmap;
	map[0x0] = NULL; //rom.bank[0];
	map[0x1] = NULL; //rom.bank[0];
	map[0x2] = NULL; //rom.bank[0];
	map[0x3] = NULL; //rom.bank[0];
...
byte mem_read(int a)
{
	...
	case 0x0:
	case 0x2:
		return read_rom(a);//rom.bank[0][a];
	case 0x4:
	case 0x6:
		return read_rom(0x4000*mbc.rombank+(a & 0x3FFF)); //rom.bank[mbc.rombank][a & 0x3FFF];
	case 0x8:
